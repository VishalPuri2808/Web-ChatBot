...
const MessageFormUi = ({//have different versions of the UI Form
setAttachment,
message,
handleChange,
handleSubmit,
    ...
    <div className="message-form-container">
      ...
      <div className="message-form">
        <div className="message-form-input-container">
          <input className="message-form-input" type = "text" value={message} onChange={handleChange} placeholder = "Start Conversation"/>
        </div>
        <div className="message-form-icons">
          <Dropzone acceptedFiles = ".jpeg,.png,.jpg" multiple = {false} noClick={true} onDrop={(acceptedFiles) => {
